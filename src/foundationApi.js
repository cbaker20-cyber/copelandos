    ...
    return json({
      ...
      modules: {
        ...
        automations: {
          ...
          message: 'Automation integrations are planning-only until a reviewed live probe exists.',
        },
        integrations: { connected: false, summary: getIntegrationSummary(env), endpoint: '/api/integrations' },
