...
- Integration roadmap routes are read-only status surfaces. Configured environment variables do not prove external connectivity; unknown or scaffold-only integrations fail closed.
