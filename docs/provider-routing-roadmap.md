...
- `config/integrations.json` treats provider routing as an internal implemented module, while live provider connectivity remains separate from configuration.
