...
`GET /api/integrations/control-loop` exposes this map for the dashboard. It reports implemented modules as ready, scaffolded systems as scaffolded, and all external systems as not connected unless future live probes exist.
...
- The task requires sending email, merging PRs, deploying, deleting files, arbitrary shell execution, screen control, or package installation.
...
- Dashboard panels display the loop from Worker data.
