...
test('scaffold-only integrations remain disconnected even when configured', () => {
...
test('checkIntegration allows implemented internal systems without connected status', () => {
